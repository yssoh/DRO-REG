...
pbaspect([1 1 1])
hold on
plot(x_dir_1000(1,:),x_dir_1000(2,:),'-b','LineWidth',1.5)
plot(x_dir_500(1,:),x_dir_500(2,:),':r','LineWidth',1.0)
plot(x_dir_2000(1,:),x_dir_2000(2,:),':g','LineWidth',1.0)
plot(x_dir_100(1,:),x_dir_100(2,:),':k','LineWidth',1.0)
hold off
saveas(gcf,'images/dro_L0L2_eps001_sensitivity.png')
...
hold on
plot(x_dir_1000(1,:),x_dir_1000(2,:),'-b','LineWidth',1.5)
plot(x_dir_500(1,:),x_dir_500(2,:),':r','LineWidth',1.5)
plot(x_dir_2000(1,:),x_dir_2000(2,:),':g','LineWidth',1.5)
plot(x_dir_100(1,:),x_dir_100(2,:),':k','LineWidth',1.5)
hold off
saveas(gcf,'images/dro_L0L2_eps001_zoomed_sensitivity.png')
