...
plotandsave(x_dir,'images/dro_L0L2_eps001_n1000.png')

%% Computing DRO for eps = 0.1
EPS = 0.1;
t = solver_DROREG(a_weights,C,EPS);
x_dir = gauge2radial(u_dir,t);
plotandsave(x_dir,'images/dro_L0L2_eps01_n1000.png')

%% Computing DRO for eps = 1.0
EPS = 1.0;
t = solver_DROREG(a_weights,C,EPS);
x_dir = gauge2radial(u_dir,t);
plotandsave(x_dir,'images/dro_L0L2_eps1_n1000.png')

%% Computing DRO for eps = 10.0
EPS = 10;
t = solver_DROREG(a_weights,C,EPS);
x_dir = gauge2radial(u_dir,t);
plotandsave(x_dir,'images/dro_L0L2_eps10_n1000.png')

%% Computing DRO for eps = 100.0
EPS = 100;
t = solver_DROREG(a_weights,C,EPS);
x_dir = gauge2radial(u_dir,t);
plotandsave(x_dir,'images/dro_L0L2_eps100_n1000.png')
