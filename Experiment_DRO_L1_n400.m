...
plotandsave(x_dir,'images/dro_L0_eps001_n400.png')

%% Computing DRO for eps = 0.1
EPS = 0.1;
t = solver_DROREG(a_weights,C,EPS);
x_dir = gauge2radial(u_dir,t);
plotandsave(x_dir,'images/dro_L0_eps01_n400.png')

%% Computing DRO for eps = 0.2
EPS = 0.2;
t = solver_DROREG(a_weights,C,EPS);
x_dir = gauge2radial(u_dir,t);
plotandsave(x_dir,'images/dro_L0_eps02_n400.png')

%% Computing DRO for eps = 0.3
EPS = 0.3;
t = solver_DROREG(a_weights,C,EPS);
x_dir = gauge2radial(u_dir,t);
plotandsave(x_dir,'images/dro_L0_eps03_n400.png')
